...
if(isset($_GET['img_DescriptionId']))
{

 $imageId= $_GET['img_DescriptionId'];
// echo "$user_del";

$del_user= $db_conn->prepare('DELETE FROM users WHERE id=:uid');
$del_user->bindParam(':uid',$user_del);
...
?>
      <script>
      alert("You are deleted one user");
